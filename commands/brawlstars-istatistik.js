...
const token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..1Gdi05agp_rYMtdAEPfCEDTGBwgm82rA7YRQHAxlIgck46bO-OQR8C3ZzJMv_-w4Nu15xgEaufELDWPXnBv8VQ'; // Token'ınızı buraya ekleyin
    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            **Klüp Tagı** : ${playerData.club.tag || "Oyuncu Herhangi Bir Klübe Katılmamış. <:carpiii:1214250638691803176>"}
            ...
            console.error(error);
            interaction.reply(`#${playerId} ID'li Oyuncu Bulunamadı.`);
        }
